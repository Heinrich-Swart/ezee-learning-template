...
function PricingCard({
  ...
  const isOnceOff = title === "Once-off Fees";
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: "text.secondary" }}>
          Explore flexible learning plans designed to fit every family’s needs.
          Whether you’re just getting started or looking for full support, our
          packages offer quality education, live classes, and helpful
          resources—all at an affordable price.
        </Typography>
      </Box>
      ...
      <Dialog open={open} onClose={handleDialogClose} fullWidth maxWidth="sm">
        ...
        <DialogContent sx={{ position: "relative", zIndex: 1 }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, mt: 1 }}>
            {(["name", "surname", "email", "number"] as FormField[]).map(
              (field) => (
                <TextField
                  key={field}
